...
--CREATE VIEW V_RELATORIO_AULA AS
--SELECT A.IDAULA AS 'ID', A.NOME AS 'Aula', A.DIA AS 'Data', A.HORA AS 'Horário', A.TOTAL AS 'Máximo', P.NOME AS 'Professor' FROM AULA AS A INNER JOIN PROFESSOR AS P ON A.ID_PROFESSOR = P.IDPROFESSOR
